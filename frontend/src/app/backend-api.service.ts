...
export class BackendApiService {
  ...
  getDistribution(frontPage: any): Observable<any> {
    return this.http.post<any>(`${API_URL}/get_distribution`, frontPage)
    .pipe(timeout(86400000));
  }

  updateMarketShare(frontPage: any): Observable<any> {
    return this.http.post<any>(`${API_URL}/update`, frontPage)
    .pipe(timeout(86400000));
  }
  ...
  searchABIM(ABIMSearchDict: any): Observable<any> {
    return this.http.post<any>(`${API_URL}/abim_search`, ABIMSearchDict)
    .pipe(timeout(86400000));
  }
